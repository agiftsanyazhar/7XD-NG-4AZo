...
--
-- Host: localhost:3306
-- Generation Time: Jan 11, 2022 at 02:09 PM
...
('cok', 'PEM-071', 'TK07', 'cok', 'cok', 2099, 'cok'),
...
--
ALTER TABLE `seqbar_nsc`
  MODIFY `barcount` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `seqbar_pegawai`
--
ALTER TABLE `seqbar_pegawai`
  MODIFY `barcount` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `seqbar_pemilik`
  MODIFY `barcount` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
